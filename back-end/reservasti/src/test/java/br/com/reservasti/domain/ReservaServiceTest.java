...
//        ReservaDTO dto = new ReservaDTO(1L, , dataRetirada, dataDevolucao);
//
...
//
//
//        ReservaRetornoDTO resultado = reservaService.solicitarReserva(funcionarioMock.getId(),dto);
//
...
//            reservaService.solicitarReserva(funcionarioMock.getId(),dto);
//        });
//
